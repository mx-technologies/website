...
const ContactUs = () => {
  return (
    <section
      id='contact-us'
      className='flex flex-col justify-center items-center max-w-[46rem] text-center py-16 mx-auto mb-20 p-2'
    >
      {/* <!-- Heading --> */}
      ...
      <p className='text-lg text-[#AEAEAE] mb-4'>
        Send us a mail to{' '}
        <a
          href='mailto:hello.mxtechnologies@gmail.com'
          className='text-white font-semibold'
        >
          hello.mxtechnologies@gmail.com
        </a>
      </p>
